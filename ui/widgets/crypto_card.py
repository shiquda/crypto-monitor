...
from PyQt6.QtGui import QColor, QContextMenuEvent, QMouseEvent
...
class CryptoCard(CardWidget):
    ...
    def refresh_style(self):
        ...
        self.setStyleSheet(
            f"CryptoCard {{ background-color: {bg_color}; border: 1px solid rgba(0,0,0,0.05); border-radius: 10px; }}"
        )
